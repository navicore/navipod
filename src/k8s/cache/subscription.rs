...
impl From<FetchResult> for DataUpdate {
    fn from(result: FetchResult) -> Self {
        match result {
            ...
            FetchResult::StatefulSets(data) => Self::StatefulSets(data),
            FetchResult::Jobs(data) => Self::Jobs(data),
            FetchResult::CronJobs(data) => Self::CronJobs(data),
...
impl SubscriptionManager {
    ...
    #[must_use]
    pub fn pattern_matches(pattern: &str, cache_key: &str) -> bool {
