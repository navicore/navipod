    ...
    pub fn text_style(&self, content_type: TextType) -> Style {
        match content_type {
            ...
            TextType::Subtitle => Style::default()
                ...
                .add_modifier(Modifier::BOLD),
            TextType::Body => Style::default().fg(self.text_primary),
            TextType::Caption => Style::default().fg(self.text_muted),
            ...
            TextType::Warning => Style::default()
                .fg(self.warning)
                .add_modifier(Modifier::BOLD),
            TextType::Error => Style::default().fg(self.error).add_modifier(Modifier::BOLD),
        }
    }
}
...
impl UiHelpers {
    ...
    pub fn status_indicator(status: ResourceStatus, theme: &NaviTheme) -> (String, Style) {
        let (symbol, color) = match status {
            ResourceStatus::Running | ResourceStatus::Ready => (Symbols::SUCCESS, theme.success),
            ResourceStatus::Pending | ResourceStatus::Updating => (Symbols::PENDING, theme.warning),
            ResourceStatus::Failed | ResourceStatus::Error => (Symbols::ERROR, theme.error),
            ResourceStatus::Unknown => (Symbols::UNKNOWN, theme.text_muted),
        };
    ...
    pub fn health_progress_bar(
        ...
        // Color codes are more readable as hex without underscores
